...
<form action="<?php echo DOMAIN ?>?controller=book&action=update" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="name" name="name" value="<?= $data['book']->name ?>" readonly>
    </div>
    <div class="mb-3">
        <label for="author" class="form-label">Tác giả</label>
        <input type="text" class="form-control" id="author" name="author" value="<?= $data['book']->author ?>" readonly>
    </div>
